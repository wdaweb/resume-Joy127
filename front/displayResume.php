...
<div class="main">
    ...
    <div class="middle">
        ...
        <div class="block6">
            <table>
                <tr>                  
                    <td style="font-size:20px; color:burlywood; font-weight:bold; text-align:center">自&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;傳</td> 
                </tr>
                <?php 
                ...
                <tr>  
                    <td>
                        <textarea name="content" cols="75" rows="40" style="background: rgba(241, 247, 248, 0.925); overflow:hidden; border:none">
                            <?=$r['content'];?>
                        </textarea>
                    </td> 
                </tr>
    ...
    <div class="footer"> 
        <a href="../admin.php?do=basic" style="float:left; font-size:14px">履歷維護管理</a>
        <a href="./resume.php" style="float:right; font-size:14px">上一頁</a>
