...
(12, 28, '1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111', 1),
(13, 27, '\r\n', 1);
...
(23, 27, '999999999aaa', '999999999aaa', '999999999aaa', '999999999aaa', 1),
(26, 28, '1234511111111', '12345', '12345', '11111111', 1),
(27, 27, '222222222222222', '222222222222222', '222222222222222', '222222222222222', 1),
(28, 27, '7777777777', '7777777777', '7777777777', '7777777777', 1);
...
(27, 'm258974613', 'qw456789', 'Lisa', '1985-12-30', 'hellolisa@google.com', '11111111', '11111111'),
(28, 'k2345968713', 'ar12345', 'WANG mai', '1996-05-28', 'ycc7123@pchome.com.tw', '12345123', '12345123');
...
(16, 23, 'm7.jpg', '生活照', 1),
(17, 23, 'm8.jpg', '工作照', 1),
(18, 28, 'Mace.jpg', '證件照', 1),
(19, 27, 'Mace.jpg', '證件照', 1);
...
(6, 28, '11111111', '11111111', '11111111', '11111111', 11111111, '1111111', 1),
(7, 27, 'kkkkkkkkkkkkkkk', 'kkkkkkkkkkkkkkk', 'kkkkkkkkkkkkkkk', 'kkkkkkkkkkkkkkk', 0, 'kkkkkkkkkkkkkkk', 1);
...
(8, 27, 'aaaaaaaaaaa', '333333333', '333333333', '333333333', 1),
(9, 27, 'ddddddddd', 'ddddddddd', 'ddddddddd', 'ddddddddd', 0);
...
(22, 27, '11111111bbb', '11111111bbb', '11111111bbb', '11111', '11111111111111111111111111111111111111111111111111\r\n11111111111111111111111111111111111111111111111111\r\n11111111111111111111111111111111111111111111111111\r\n11bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb\r\nbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb', 1),
(23, 27, '2222222222222', '2222222222222', '2222222222222', '11111', '22222222222222222222222222222222222222222222222222\r\n22222222222222222222222222222222222222222222222222\r\n22222222222222222222222222222222222222222222222222\r\n222222', 1),
(24, 27, '333333333', '333333333', '333333333', '333333333', '33333333333333333333333333333333333333333333333333\r\n33333333333333333333333333333333333333333333333333\r\n33333333333333333333333333333333333333333333333333\r\n333', 1);
...
--
ALTER TABLE `bio`
  MODIFY `bid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主鍵/使用者流水號', AUTO_INCREMENT=14;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `edu`
--
ALTER TABLE `edu`
  MODIFY `eid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主鍵/使用者流水號', AUTO_INCREMENT=29;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `member`
--
ALTER TABLE `member`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主鍵/使用者流水號', AUTO_INCREMENT=29;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `photo`
--
ALTER TABLE `photo`
  MODIFY `pid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '流水號/主鍵', AUTO_INCREMENT=20;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `search`
--
ALTER TABLE `search`
  MODIFY `sid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主鍵/使用者流水號', AUTO_INCREMENT=8;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `skill`
--
ALTER TABLE `skill`
  MODIFY `skid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主鍵/使用者流水號', AUTO_INCREMENT=10;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `workexp`
--
ALTER TABLE `workexp`
  MODIFY `wid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主鍵/使用者流水號', AUTO_INCREMENT=25;
COMMIT;
